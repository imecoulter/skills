...
Don't reach for it to *decide* what to build; for that, [grill](https://aihero.dev/skills-grill) and [to-spec](https://aihero.dev/skills-to-spec) are the tools.

...
You invoke this by typing `/setup-imecoulter-skills` — the agent won't reach for it on its own. It is deliberately marked non-invokable, so no other skill can fire it for you.

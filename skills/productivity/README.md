...
- **[close](./close/SKILL.md)** — Close out the session: finish agreed work, run the repo's checks, merge the session's changes into the default branch, close their tickets, sweep worktrees and branches, and report what needs you and what's next.
- **[grill](./grill/SKILL.md)** — Get grilled relentlessly about a plan, decision or idea, a round of questions at a time, with the domain language and hard decisions recorded in `CONTEXT.md` and ADRs as they're settled.

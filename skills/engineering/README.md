...
- **[setup-imecoulter-skills](./setup-imecoulter-skills/SKILL.md)** — Configure this repo for the engineering skills (issue tracker, triage labels, domain doc layout). Run once per repo.
...
- **[build](./build/SKILL.md)** — Build a ticket, spec or agreed plan in its own worktree, driving `/tdd` at pre-agreed seams and `/code-review` before landing it on the default branch through `/close`.

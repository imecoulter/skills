# Verify/Check Mode for `setup-imecoulter-skills`

This project will not add a dedicated verify/check mode (or a separate verify skill) for `setup-imecoulter-skills`.
...
- #106 — Feature request: verify/check mode for setup-imecoulter-skills
